...
_CODE_TRACEABILITY_SOURCE_TABLE_COLUMNS: dict[str, tuple[str, ...]] = {
    ...
    "code_evidence": (
        ...
        "evidence_type", "claim", "source_role", "relevance_summary",
        "scope_relation", "source_origin", "interpretation_limit",
        "baseline_presence", "baseline_workspace_state_id",
        "baseline_provenance_note", "context_contract_version",
        "declared_revision", "workspace_state_id",
