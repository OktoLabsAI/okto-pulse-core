...
@pytest.mark.asyncio
async def test_quality_mcp_inventory_remains_five_tools_at_313() -> None:
    ...
    # contract, so the installed inventory intentionally remains at 313.
    assert len(tools) == 313
    assert {
