...
from sqlalchemy_test_models import Board, Ideation, Spec
from okto_pulse.core.domain.realm import RealmScope


class SQLAlchemyBoardRepository:
    def __init__(self, session: AsyncSession, realm_scope: RealmScope | None = None) -> None:
        self._session = session
        self.realm_scope = realm_scope or RealmScope.local()
