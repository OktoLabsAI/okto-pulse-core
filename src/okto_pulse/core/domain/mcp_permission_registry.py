...
MCP_TOOL_PERMISSION_POLICIES: tuple[McpToolPermissionPolicy, ...] = (
    ...
    _policy("okto_pulse_get_historical_context", "spec.entity.read", "card.entity.read"),
    ...
    _policy("okto_pulse_get_requirement_verification", "spec.entity.read", "spec.integration_requirements.read", "spec.observability_requirements.read"),
    _policy(
        "okto_pulse_get_resource_gate_summary",
    ...
    _policy("okto_pulse_kg_create_learning_capture",
    ...
    _policy("okto_pulse_kg_get_learning_capture_context",
        "board.read", "card.entity.read", "card.entity.context_read", "card.validation.read",
        "card.comments.read", "card.conclusion.read", "card.tests.read", "spec.entity.read", "spec.tests.read"),
    ...
    _policy("okto_pulse_kg_list_learning_captures",
        "board.read", "card.entity.read", "card.entity.context_read", "card.validation.read",
        "card.comments.read", "card.conclusion.read", "card.tests.read", "spec.entity.read", "spec.tests.read",
    ...
    _policy("okto_pulse_list_architecture_classifications", "spec.entity.read", "spec.architecture.read", "spec.integration_requirements.read"),
    _policy(
