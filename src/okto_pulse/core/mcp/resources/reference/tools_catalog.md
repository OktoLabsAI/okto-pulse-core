...
- `okto_pulse_get_card_knowledge_propagation` — docs: `okto-pulse://reference/tool-docs/knowledge`
...
- `okto_pulse_refresh_card_knowledge_assignments` — docs: `okto-pulse://reference/tool-docs/knowledge`
