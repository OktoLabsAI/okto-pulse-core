...
Cada arquivo `.md` neste diretório é exposto via `@mcp.resource(uri="okto-pulse://workflows/<nome>")` e contém o workflow operacional de uma entidade do SDLC (cards, specs, ideations, refinements, kg, stories).
