...
- **277 MCP tools** — Complete Model Context Protocol command catalog for AI agent integration, counted from the transport-neutral Core catalog after importing the server, including:
  ...
  - Community runtime exposure: 277 core MCP tools, 0 community-only MCP tools
...
| --- | --- | ---: | ---: |
| Core import rows | Core | 4971 | classified |
| Community-to-Core import rows | Community | 665 | classified |
