...
- **292 MCP tools** — Complete Model Context Protocol command catalog for AI agent integration, counted from the transport-neutral Core catalog after importing the server, including:
  ...
  - Community runtime exposure: 292 core MCP tools, 0 community-only MCP tools
...
| --- | --- | ---: | ---: |
| Core import rows | Core | 5780 | classified |
| Community-to-Core import rows | Community | 804 | classified |
