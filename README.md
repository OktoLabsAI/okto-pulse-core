...
**Current: 0.3.3** — Core defines actionable semantic evidence, agent-mediated
...
| --- | --- | ---: | ---: |
| Core import rows | Core | 7414 | classified |
| Community-to-Core import rows | Community | 1230 | classified |
...
Implementation and integration tracking: [Delivery Evidence — tasks, test cards and Spec closure](docs/DELIVERY_EVIDENCE_PLAN.md).
Includes the provider-neutral completion gate, REST/MCP contracts, agent guidance
and paired Community persistence/UI. Not installed into the active user runtime.
